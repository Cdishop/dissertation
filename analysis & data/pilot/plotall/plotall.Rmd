...
The theoretical distribution. With two random walks, the greatest probabilities occur over $Time$ = max or $Time$ = min. A given walk has the greatest chance of spending all or no periods in the lead.

![x-axis = Time, y-axis = Probability of Spending n Periods in the Lead](llimage.png)

The distribution of my empirical data from GitHub issues. As shown, for any bi-user comparison, a given request pool has the greatest chance of spending all or no periods in the lead. 
