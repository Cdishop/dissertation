...
Only going to look at the first 119 days (roughly the length of the shortest series)
...
Percentages here indicate the number of periods (out of 119) that series x_i was on top. If the percent is 0.67, that means repo i spent 355/530 periods as the top request pool. 
